...
func New(ctx context.Context, baseURL string, model string) *Agent {
	...
	registry.AddTool(&fs.EditTool{})
	registry.AddTool(&fs.ListDirTool{})
	registry.AddTool(&fs.DeleteFileTool{})
	registry.AddTool(&fs.MakeDirTool{})
	registry.AddTool(&fs.MoveFileTool{})
	registry.AddTool(&fs.ChangeDirTool{})
